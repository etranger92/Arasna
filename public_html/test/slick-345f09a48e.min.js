! function (e, t) {
    ...
    x.extend(x.event, {
        trigger: function (t, n, o, r) {
            ...
            if (a = h = l = o = o || i, 3 !== o.nodeType && 8 !== o.nodeType && !Tt.test(m + x.event.triggered) && (-1 < m.indexOf(".") && (m = (w = m.split(".")).shift(), w.sort()), d = m.indexOf(":") < 0 && "on" + m, (t = t[x.expando] ? t : new x.Event(m, "object" == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = w.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + w.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : x.makeArray(n, [t]), f = x.event.special[m] || {}, r || !f.trigger || !1 !== f.trigger.apply(o, n))) {
                if (!r && !f.noBubble && !g(o)) {
                    for (c = f.delegateType || m, Tt.test(c + m) || (a = a.parentNode); a; a = a.parentNode) y.push(a), l = a;
                ...
                return t.type = m, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(y.pop(), n) || !V(o) || d && v(o[m]) && !g(o) && ((l = o[d]) && (o[d] = null), x.event.triggered = m, t.isPropagationStopped() && h.addEventListener(m, kt), o[m](), t.isPropagationStopped() && h.removeEventListener(m, kt), x.event.triggered = void 0, l && (o[d] = l)), t.result
            }
        },
    ...
    Rt.href = St.href, x.extend({
        ...
        ajax: function (t, n) {
            ...
            if (k = "abort", m.add(h.complete), S.done(h.success), S.fail(h.error), o = Bt(zt, h, n, S)) {
            ...
            function C(t, n, i, a) {
                ...
                }(h, b, S, c), c ? (h.ifModified && ((T = S.getResponseHeader("Last-Modified")) && (x.lastModified[r] = T), (T = S.getResponseHeader("etag")) && (x.etag[r] = T)), 204 === t || "HEAD" === h.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = b.state, p = b.data, c = !(f = b.error))) : (f = k, !t && k || (k = "error", t < 0 && (t = 0))), S.status = t, S.statusText = (n || k) + "", c ? y.resolveWith(v, [p, k, S]) : y.rejectWith(v, [S, k, f]), S.statusCode(w), w = void 0, u && g.trigger(c ? "ajaxSuccess" : "ajaxError", [S, h, c ? p : f]), m.fireWith(v, [S, k]), u && (g.trigger("ajaxComplete", [S, h]), --x.active || x.event.trigger("ajaxStop")))
            }
            return S
        },
